...
# Привет, я Киричек Мария!

### Студент, начинающий исследователь в области машинного обучения

В настоящее время работаю над проектом **Радиомика-MAS**, который посвящён медицинской диагностике с применением методов машинного обучения. Активно углубляю знания в области баз данных, в частности изучаю **SQL**, и продолжаю развиваться в ML-инжиниринге.

Открыта для сотрудничества в проектах, связанных с **большими языковыми моделями (LLM)** и **обработкой естественного языка (NLP)**. Также ищу наставничество и поддержку в построении production-решений и более глубоком освоении инженерной стороны машинного обучения.

Готова делиться опытом в области машинного обучения, анализа данных и работы с базами данных. Связаться со мной можно по электронной почте: **kirimusha@mail.ru**.

Помимо программирования я умею стоять на голове. Регулярно веду заметки и публикую мысли о технологиях в Telegram: **[https://t.me/kirimushroom](https://t.me/kirimushroom)**.
...
Библиотеки для анализа и вычислений:
